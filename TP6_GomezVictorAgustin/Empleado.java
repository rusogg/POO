...
public class Empleado extends Persona{
    ...
    public Empleado (int p_nroDni, String p_nombre,String p_apellido, Calendar p_fecha, long p_cuil, double p_importe, int p_anioingreso){
    ...
    public Empleado (int p_nroDni, String p_nombre,String p_apellido, Calendar p_fecha, long p_cuil, double p_importe, Calendar p_fechaIngreso){
        super(p_nroDni, p_nombre, p_apellido, p_fecha);
        this.setCuil(p_cuil);
        this.setSueldoBasico(p_importe);
